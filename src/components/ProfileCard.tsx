...
const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  return (
    <div className="bg-zinc-900 rounded-lg p-6 flex flex-col items-center shadow-[0_24px_80px_hsla(0,0%,0%,0.25)] w-full max-w-xs border border-[hsl(0,0%,22%)] max-h-fit sticky top-10">
